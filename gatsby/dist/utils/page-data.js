...
function modifyPageDataForErrorMessage(input) {
  ...
  const optionalData = { ...((_input$result = input.result) !== null && _input$result !== void 0 && _input$result.pageContext ? {
  ...
  const optionalErrors = { ...((_input$result3 = input.result) !== null && _input$result3 !== void 0 && _input$result3.errors ? {
